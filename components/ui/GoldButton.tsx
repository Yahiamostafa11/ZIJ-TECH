...
export function GoldButton({ children, variant = "filled", className, ...props }: GoldButtonProps) {
  const baseClasses =
    "relative inline-flex items-center justify-center rounded px-6 py-2.5 font-dmsans text-sm font-semibold transition-all duration-300 shadow-button";
  ...
  const filledClasses =
    "border border-gold-light/20 bg-gold-gradient text-on-accent hover:brightness-110 hover:shadow-[0_0_28px_rgba(242,193,102,0.26)]";
