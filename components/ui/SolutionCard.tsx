...
export function SolutionCard({ icon: Icon, title, description }: SolutionCardProps) {
  return (
    <div className="group flex min-h-[210px] flex-col rounded-lg border border-border-subtle bg-bg-card/78 p-5 shadow-card transition duration-300 hover:-translate-y-1 hover:border-gold-light/60 hover:shadow-[0_0_32px_rgba(242,193,102,0.14)]">
