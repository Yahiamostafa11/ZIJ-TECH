...
const WORK_EN: WorkItem[] = [
  {
    ...
    note: "A complete management system for dental laboratories, built by ZIJ from the ground up.",
  },
  {
    key: "iot-maintenance",
    ...
    note: "Factory maintenance system that watches machines through sensors to catch faults before they stop production.",
  },
  {
    key: "digital-twin",
  ...
  { key: "styliiiish", name: "Styliiiish", url: "https://styliiiish.com/", division: "software", kind: "Custom web platform", note: "Designed and developed by ZIJ." },
  { key: "masar-vet", name: "Masar Vet", url: "https://masar-vet.com/", division: "software", kind: "Custom web platform", note: "Designed and developed by ZIJ." },
  { key: "bayodent", name: "Bayodent Lab", url: "https://bayodent-lab.com/", division: "software", kind: "WordPress website", note: "Designed and hosted by ZIJ." },
  { key: "vastr", name: "Vastr", url: "https://vastr.store/", division: "software", kind: "WordPress store", note: "Designed by ZIJ." },
];

const WORK_AR: WorkItem[] = [
  { ...WORK_EN[0], name: "نظام معامل الأسنان", kind: "SaaS · منتج خاص بنا", note: "نظام متكامل لإدارة معامل الأسنان، طوّرته زيج من الصفر." },
  { ...WORK_EN[1], name: "الصيانة التنبؤية بإنترنت الأشياء", kind: "إنترنت الأشياء · أنظمة مدمجة · صناعة", note: "نظام صيانة للمصانع يراقب الماكينات عبر الحساسات ليكشف الأعطال قبل أن توقف الإنتاج." },
  ...
  { ...WORK_EN[4], kind: "منصة ويب مخصصة", note: "تصميم وتطوير زيج." },
  { ...WORK_EN[5], kind: "منصة ويب مخصصة", note: "تصميم وتطوير زيج." },
  { ...WORK_EN[6], kind: "موقع ووردبريس", note: "تصميم واستضافة زيج." },
  { ...WORK_EN[7], kind: "متجر ووردبريس", note: "تصميم زيج." },
];
